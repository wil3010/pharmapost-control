...
if(isset($_POST['submit']))
{
	...
	$productsAmount=$_POST['productAmount'];
	$productavailability=$_POST['productAvailability'];
	
$sql=mysqli_query($con,"update  products set category='$category',subCategory='$subcat',productName='$productname',productCompany='$productcompany',productPrice='$productprice',productDescription='$productdescription',shippingCharge='$productscharge',productAmount='$productsAmount',productAvailability='$productavailability',productPriceBeforeDiscount='$productpricebd' where id='$pid' ");
...
<div class="controls">
<input type="text"    name="productAmount"  placeholder="Ingres Cantidad de Producto" value="<?php echo htmlentities($row['productAmount']);?>" class="span8 tip" required>
</div>
</div>
<div class="control-group">
...
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage1']);?>" width="200" height="100"> <a href="cargar_imagen1.php?id=<?php echo $row['id'];?>">Cargar Imagen</a>
</div>
</div>
...
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage2']);?>" width="200" height="100"> <a href="cargar_imagen2.php?id=<?php echo $row['id'];?>">Cargar Imagen</a>
</div>
</div>
...
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage3']);?>" width="200" height="100"> <a href="cargar_imagen3.php?id=<?php echo $row['id'];?>">Cargar Imagen</a>
</div>
</div>
<?php } ?>
	<div class="control-group">
