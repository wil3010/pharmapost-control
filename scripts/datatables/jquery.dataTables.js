...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( oLanguage )
	{
		...
		if ( !oLanguage.sEmptyTable && oLanguage.sZeroRecords &&
			oDefaults.sEmptyTable === "No existen datos disponibles en la tabla." )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *  @type string
			 *  @default No existen datos disponibles en la tabla.
			 *
			 *  @dtopt Language
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "info": "Got a total of _TOTAL_ Entradas to show (_START_ to _END_)"
			 *        }
			 *      } );
			 *    } );
			 */
			 ...
			 *  @type string
			 *  @default (filtrado de _MAX_ total Entradas)
			 *
			 *  @dtopt Language
